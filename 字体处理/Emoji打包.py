...
def main(argv):
    ...
    argv = ['Emoji打包.py', '.\data\emoji.ttf', '.\data\emojix.ttf', '.\data\png\\']
...
Emoji打包.py [-V] [-O] [-U] [-A] font.ttf out-font.ttf strike-prefix...
...
""")
    ...
    font_metrics = FontMetrics(font['head'].unitsPerEm,
                               ...
                               -font['hhea'].descent)
    print(
        "Font metrics: upem=%d ascent=%d descent=%d." % (font_metrics.upem, font_metrics.ascent, font_metrics.descent))
